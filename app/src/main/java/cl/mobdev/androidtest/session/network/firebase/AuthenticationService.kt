package cl.mobdev.androidtest.session.network.firebase

import cl.mobdev.androidtest.session.presentation.login.LoginResult
import cl.mobdev.androidtest.session.presentation.login.SignInResult
